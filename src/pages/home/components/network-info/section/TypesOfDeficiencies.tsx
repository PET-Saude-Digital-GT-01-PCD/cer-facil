          ...
          {items.map((item, idx) => (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p
                  aria-hidden="true"
                  className="inline text-[color-mix(in_srgb,var(--cor-bg-3),black_20%)] text-xl text-center leading-relaxed font-medium focus-within:border-[var(--cor-bg-1)] focus-within:border-5"
                >
                  {item.text}
                </p>
              </div>
