            ...
            <div className="flex flex-wrap items-center gap-3">
              {filterOptions.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-full font-bold text-xl transition-all duration-200 border-2 
                                            ${
                                              isActive
              ...
              {activeFilters.length > 0 && (
                <button
                  ...
                  className="ml-2 text-slate-400 hover:text-red-500 text-lg font-medium"
                >
                  Limpar tudo
                </button>
              )}
            ...
            {filteredProfessionals.map((prof) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span
                      className={`text-2xl font-bold transition-colors ${isOpen ? "text-[var(--cor-bg-3)]" : "text-slate-800"}`}
                    >
